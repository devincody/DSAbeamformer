...
void detect_sum(cuComplex const * __restrict__ input, int n_avg,  float * __restrict__ output){
	...
	*/
	...
	// shmem[beam_idx] += input[input_idx +  0*N_BEAMS].x*input[input_idx +  0*N_BEAMS].x + input[input_idx +  0*N_BEAMS].y*input[input_idx +  0*N_BEAMS].y;
	// shmem[beam_idx] += input[input_idx +  1*N_BEAMS].x*input[input_idx +  1*N_BEAMS].x + input[input_idx +  1*N_BEAMS].y*input[input_idx +  1*N_BEAMS].y;
	// shmem[beam_idx] += input[input_idx +  2*N_BEAMS].x*input[input_idx +  2*N_BEAMS].x + input[input_idx +  2*N_BEAMS].y*input[input_idx +  2*N_BEAMS].y;
	// shmem[beam_idx] += input[input_idx +  3*N_BEAMS].x*input[input_idx +  3*N_BEAMS].x + input[input_idx +  3*N_BEAMS].y*input[input_idx +  3*N_BEAMS].y;
	// shmem[beam_idx] += input[input_idx +  4*N_BEAMS].x*input[input_idx +  4*N_BEAMS].x + input[input_idx +  4*N_BEAMS].y*input[input_idx +  4*N_BEAMS].y;
	// shmem[beam_idx] += input[input_idx +  5*N_BEAMS].x*input[input_idx +  5*N_BEAMS].x + input[input_idx +  5*N_BEAMS].y*input[input_idx +  5*N_BEAMS].y;
	// shmem[beam_idx] += input[input_idx +  6*N_BEAMS].x*input[input_idx +  6*N_BEAMS].x + input[input_idx +  6*N_BEAMS].y*input[input_idx +  6*N_BEAMS].y;
	// shmem[beam_idx] += input[input_idx +  7*N_BEAMS].x*input[input_idx +  7*N_BEAMS].x + input[input_idx +  7*N_BEAMS].y*input[input_idx +  7*N_BEAMS].y;
	// shmem[beam_idx] += input[input_idx +  8*N_BEAMS].x*input[input_idx +  8*N_BEAMS].x + input[input_idx +  8*N_BEAMS].y*input[input_idx +  8*N_BEAMS].y;
	// shmem[beam_idx] += input[input_idx +  9*N_BEAMS].x*input[input_idx +  9*N_BEAMS].x + input[input_idx +  9*N_BEAMS].y*input[input_idx +  9*N_BEAMS].y;
	// shmem[beam_idx] += input[input_idx + 10*N_BEAMS].x*input[input_idx + 10*N_BEAMS].x + input[input_idx + 10*N_BEAMS].y*input[input_idx + 10*N_BEAMS].y;
	// shmem[beam_idx] += input[input_idx + 11*N_BEAMS].x*input[input_idx + 11*N_BEAMS].x + input[input_idx + 11*N_BEAMS].y*input[input_idx + 11*N_BEAMS].y;
	// shmem[beam_idx] += input[input_idx + 12*N_BEAMS].x*input[input_idx + 12*N_BEAMS].x + input[input_idx + 12*N_BEAMS].y*input[input_idx + 12*N_BEAMS].y;
	// shmem[beam_idx] += input[input_idx + 13*N_BEAMS].x*input[input_idx + 13*N_BEAMS].x + input[input_idx + 13*N_BEAMS].y*input[input_idx + 13*N_BEAMS].y;
	// shmem[beam_idx] += input[input_idx + 14*N_BEAMS].x*input[input_idx + 14*N_BEAMS].x + input[input_idx + 14*N_BEAMS].y*input[input_idx + 14*N_BEAMS].y;
	// shmem[beam_idx] += input[input_idx + 15*N_BEAMS].x*input[input_idx + 15*N_BEAMS].x + input[input_idx + 15*N_BEAMS].y*input[input_idx + 15*N_BEAMS].y;
	// shmem[beam_idx] += input[input_idx + 16*N_BEAMS].x*input[input_idx + 16*N_BEAMS].x + input[input_idx + 16*N_BEAMS].y*input[input_idx + 16*N_BEAMS].y;
	// shmem[beam_idx] += input[input_idx + 17*N_BEAMS].x*input[input_idx + 17*N_BEAMS].x + input[input_idx + 17*N_BEAMS].y*input[input_idx + 17*N_BEAMS].y;
	// shmem[beam_idx] += input[input_idx + 18*N_BEAMS].x*input[input_idx + 18*N_BEAMS].x + input[input_idx + 18*N_BEAMS].y*input[input_idx + 18*N_BEAMS].y;
	// shmem[beam_idx] += input[input_idx + 19*N_BEAMS].x*input[input_idx + 19*N_BEAMS].x + input[input_idx + 19*N_BEAMS].y*input[input_idx + 19*N_BEAMS].y;
	// shmem[beam_idx] += input[input_idx + 20*N_BEAMS].x*input[input_idx + 20*N_BEAMS].x + input[input_idx + 20*N_BEAMS].y*input[input_idx + 20*N_BEAMS].y;
	// shmem[beam_idx] += input[input_idx + 21*N_BEAMS].x*input[input_idx + 21*N_BEAMS].x + input[input_idx + 21*N_BEAMS].y*input[input_idx + 21*N_BEAMS].y;
	// shmem[beam_idx] += input[input_idx + 22*N_BEAMS].x*input[input_idx + 22*N_BEAMS].x + input[input_idx + 22*N_BEAMS].y*input[input_idx + 22*N_BEAMS].y;
	// shmem[beam_idx] += input[input_idx + 23*N_BEAMS].x*input[input_idx + 23*N_BEAMS].x + input[input_idx + 23*N_BEAMS].y*input[input_idx + 23*N_BEAMS].y;
	// shmem[beam_idx] += input[input_idx + 24*N_BEAMS].x*input[input_idx + 24*N_BEAMS].x + input[input_idx + 24*N_BEAMS].y*input[input_idx + 24*N_BEAMS].y;
	// shmem[beam_idx] += input[input_idx + 25*N_BEAMS].x*input[input_idx + 25*N_BEAMS].x + input[input_idx + 25*N_BEAMS].y*input[input_idx + 25*N_BEAMS].y;
	// shmem[beam_idx] += input[input_idx + 26*N_BEAMS].x*input[input_idx + 26*N_BEAMS].x + input[input_idx + 26*N_BEAMS].y*input[input_idx + 26*N_BEAMS].y;
	// shmem[beam_idx] += input[input_idx + 27*N_BEAMS].x*input[input_idx + 27*N_BEAMS].x + input[input_idx + 27*N_BEAMS].y*input[input_idx + 27*N_BEAMS].y;
	// shmem[beam_idx] += input[input_idx + 28*N_BEAMS].x*input[input_idx + 28*N_BEAMS].x + input[input_idx + 28*N_BEAMS].y*input[input_idx + 28*N_BEAMS].y;
	// shmem[beam_idx] += input[input_idx + 29*N_BEAMS].x*input[input_idx + 29*N_BEAMS].x + input[input_idx + 29*N_BEAMS].y*input[input_idx + 29*N_BEAMS].y;
	// shmem[beam_idx] += input[input_idx + 30*N_BEAMS].x*input[input_idx + 30*N_BEAMS].x + input[input_idx + 30*N_BEAMS].y*input[input_idx + 30*N_BEAMS].y;
	// shmem[beam_idx] += input[input_idx + 31*N_BEAMS].x*input[input_idx + 31*N_BEAMS].x + input[input_idx + 31*N_BEAMS].y*input[input_idx + 31*N_BEAMS].y;
...
// cudaStreamCallback_t call_write_to_disk(std::ofstream *f, std::mutex *mtx, int current_gemm, cudaEvent_t wait_event, float *data){
// 	std::cout << "writing to disk" << std::endl;
// 	gpuErrchk(cudaEventSynchronize(wait_event));
// 	std::cout << "event sync" << std::endl;
// 	std::lock_guard<std::mutex> bar(*mtx);
...
// void *launch_beamformer(cublasHandle_t handle, )
